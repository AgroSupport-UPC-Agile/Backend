Feature: US04 Programación de citas con asesores
  ...
  Scenario Outline: Programar cita
    ...
    Examples:
      | granjero | asesor    | horario            | boton    | mensaje                   |
      | Manuel   | Mario A.  | 8:00 am - 10:00 am | Reservar | Cita programada con éxito |
      | María    | Sofía B.  | 9:00 am - 11:00 am | Reservar | Cita programada con éxito |

  Scenario Outline: Fallar al programar cita
    Given el "<granjero>" con poca experiencia desea programar una cita.
    ...
    Examples:
      | granjero | asesor    | horario            | error | mensaje           |
